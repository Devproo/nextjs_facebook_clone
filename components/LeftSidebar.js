  ...
  return (
    <div className="px-4 fixed mt-5 hidden lg:block">
      <div className="flex flex-col gap-2">
        ...
        />
        <LeftSidebarLink image="/friends" text="Friends" />
        ...
        <div className="flex items-center gap-3 w-[300px] py-2 pl-1 hover:bg-gray-300 cursor-pointer">
          <div
            className="bg-gray-300 h-[30px] w-[30px] grid place-items-center roundful
          "
          >
            <BsChevronDown />
          </div>
        ...
        <p className="text-[14px] text-grey-500 mt-2">
